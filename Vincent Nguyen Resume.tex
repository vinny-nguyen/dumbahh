...
recognition data, showing real-time past conversation details to facilitate active memory recall.
    ...
    \section{Technologies}
        ...
        \begin{onecolentry}
            \textbf{Languages:} Python, C, Arduino C++, C\#, Java, HTML5, CSS3, JavaScript, Racket, MATLAB/Simulink
        \end{onecolentry}
        ...
        \begin{onecolentry}
            \textbf{Tools:} Git, Docker, Bash, Linux, MongoDB, Supabase, Firebase, Whisper, Onshape, Klipper\end{onecolentry}
